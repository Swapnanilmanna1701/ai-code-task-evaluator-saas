...
export default function RadialOrbitalTimeline({
  ...
  return (
    <div
      className="w-full h-[600px] flex flex-col items-center justify-center bg-slate-900 dark:bg-black rounded-2xl overflow-hidden"
      ref={containerRef}
          ...
          {timelineData.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 dark:bg-slate-900/90 backdrop-blur-lg border-white/30 shadow-xl shadow-white/10 overflow-visible text-white">
