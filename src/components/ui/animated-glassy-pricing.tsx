...
export const PricingCard = ({
  planName, description, price, priceLabel = '/mo', features, buttonText, isPopular = false, buttonVariant = 'primary', onButtonClick
}: PricingCardProps) => {
  const cardClasses = `
  ...
  return (
    <div className={cardClasses.trim()}>
      ...
      <div className="my-6 flex items-baseline gap-2">
        ...
        <span className="text-[14px] text-foreground/70 font-sans">{priceLabel}</span>
      </div>
...
export const ModernPricingSection = ({
  ...
  return (
    <div className="relative text-foreground w-full overflow-hidden py-20">
      {showAnimatedBackground && <ShaderCanvas />}
      <div className="relative w-full flex flex-col items-center justify-center px-4">
        <div className="w-full max-w-5xl mx-auto text-center mb-14">
          <h2 className="text-[32px] md:text-[48px] font-bold leading-tight tracking-[-0.03em] text-foreground">
            {title}
          </h2>
